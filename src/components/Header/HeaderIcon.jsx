function HeaderIcon() {
  return (
    <svg
      ...
      viewBox='0 0 32 32'
      xmlSpace='preserve'
      className='main-img max-w-sm hidden md:block'
    >
      <g>
        <path
          d='M30,28H2c-0.3,0-0.7-0.2-0.9-0.5c-0.2-0.3-0.2-0.7,0-1l2-3C3.3,23.2,3.6,23,4,23h24c0.4,0,0.7,0.2,0.9,0.6l2,3
c0.2,0.3,0.1,0.7,0,1C30.7,27.8,30.3,28,30,28z'
        />
      </g>
      <path
        d='M27,5H5C4.4,5,4,5.4,4,6v14c0,0.6,0.4,1,1,1h22c0.6,0,1-0.4,1-1V6C28,5.4,27.6,5,27,5z M11.7,15.3c0.4,0.4,0.4,1,0,1.4
